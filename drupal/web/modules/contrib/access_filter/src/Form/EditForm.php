...
class EditForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['conditions']['conditions'] = [
      ...
      '#description' => $this->t('Write in YAML format like below...') . '<br>' . $this->renderPluginDescription($this->conditionPluginManager->getDefinitions()) . $this->t('All conditions can be negated by specifying "negate: 1".'),
      '#attributes' => ['data-yaml-editor' => 'true'],
      '#default_value' => $filter->get('conditions'),
    ];
    ...
    $form['rules']['rules'] = [
      ...
      '#attributes' => ['data-yaml-editor' => 'true'],
      '#default_value' => $filter->get('rules'),
    ];
    ...
    $form['response']['code'] = [
      ...
      '#default_value' => $filter->get('parsedResponse')['code'],
    ];
    $form['response']['redirect_url'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Redirect URL'),
      '#description' => $this->t('Affects only response code 301, 302.'),
      '#default_value' => $filter->get('parsedResponse')['redirect_url'],
    ];
    $form['response']['body'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Response body'),
      '#description' => $this->t('Affects only response code except 301, 302.'),
      '#default_value' => $filter->get('parsedResponse')['body'],
    ];
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $dumper = new Dumper();
    $filter->set('response', $dumper->dump($form_state->getValue('response'), FALSE));
